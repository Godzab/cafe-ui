...
man_pages = [
    ('index', u'Cafe UI Documentation',
     'Documentation for the Cafe UI plugin to the Openstack\
      Dashboard (Horizon)',
     [u'OpenStack'], 1)
]
...
texinfo_documents = [
    ('index', 'Cafe UI',
     u'Cafe UI Documentation', u'OpenStack',
     'Cafe UI',
     'Cafe User Interface', 'Miscellaneous'),
]
